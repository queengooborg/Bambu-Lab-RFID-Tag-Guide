...
An open-source standard proposal, OpenTag3D, was previously being incubated in this repository, and has since moved to its own repository. For a description of the standard, see https://opentag3d.info/.
